...
if is_pp
    if m_obj == 0.0
        ...
        load_system('pick_place_obj.slx');
        result=sim('pick_place_obj.slx', 'ReturnWorkspaceOutputs','on'); %simulate and extract results        
    end
else
...
if rec
    v = VideoWriter("RSoft_Pendulum_atan.avi");
    open(v);
end
